...
- 河南九象酒业有限公司（2015.3——2016.3）
  ...
  + 工作期间认识到自己不懂得地方很多，于是重新学习Html、css以及JavaScript基础部分，能全手写网站的前端页面，同时进一步熟悉了源码建站，熟练掌握论坛网站（如Discuz!和phpwind）、商城网站（如ECSHOP）、企业网站、博客网站以及织梦（DEDECMS）、帝国（EmpireCMS）等CMS网站的搭建和部署；
  

- 邦瑞科技有限公司（2016.3——至今）
  + 负责公司微友网站的页面改版以及与后台php的交互
  + 负责开发公司的微商海报制作、图片加水印以及签到日历模块
  + 工作期间对前端有了更深刻的认识， 坚持每天下班学习
